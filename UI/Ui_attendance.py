...
class Ui_attendance(object):
    def setupUi(self, attendance):
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(380, 0, 301, 81))
        ...
        self.ScrollArea = ScrollArea(attendance)
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(600, 0, 81, 111))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.late = CheckBox(self.verticalLayoutWidget)
        self.late.setObjectName("late")
        self.verticalLayout.addWidget(self.late)
        self.workOver = CheckBox(self.verticalLayoutWidget)
        self.workOver.setObjectName("workOver")
        self.verticalLayout.addWidget(self.workOver)
        self.lake = CheckBox(self.verticalLayoutWidget)
        self.lake.setObjectName("lake")
        self.verticalLayout.addWidget(self.lake)
    ...
    def retranslateUi(self, attendance):
        ...
        self.select.setText(_translate("attendance", "查询"))
        self.comboBox.setText(_translate("attendance", "日期范围"))
        self.label.setText(_translate("attendance", "上班时间:"))
        self.label_2.setText(_translate("attendance", "下班时间:"))
        self.late.setText(_translate("attendance", "迟到"))
        self.workOver.setText(_translate("attendance", "加班"))
        self.lake.setText(_translate("attendance", "漏刷"))
from qfluentwidgets import CheckBox, ComboBox, LineEdit, PixmapLabel, PushButton, ScrollArea, TableWidget, TimePicker
